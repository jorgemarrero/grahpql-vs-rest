...
```notes
You use you existing application code
```
...
<ul className="appear-list">
  <Appear>
    <h2><li>GraphQL Resolvers ☎️</li></h2>
    <h2><li>GraphQL Variables 🔠</li></h2>
    <h2><li>GraphQL Fragments 📃</li></h2>
    <h2><li>GraphQL Subcriptions ⏰</li></h2>
    <h2><li>Prisma - GraphQL database abstraction 💎</li></h2>
    <h2><li>Reference: GitHub GraphQL API 🔝</li></h2>
  </Appear>
</ul>