...
<CodeSurfer
  ...
  dark
	steps={[
		{ range: [1,7] },
		{ range: [9, 11], notes: "Hypermedia - Machine readable "},
		{ lines: [9]}
	]}
/>
...
REST has **multiple endpoints** 📚 that return **fixed data structures** 🔒
...
<CodeSurfer
  ...
  steps={[
		...
		{ lines:[1, 10, 11, 12, 16, 24, 41, 46, 50, 52], notes: "Over-fetching → Bandwidth? Memory?"},
	]}
/>
...
# "RESTful APIs are optimized for server, not client"
